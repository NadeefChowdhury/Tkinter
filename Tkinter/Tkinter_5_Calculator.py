...
root = Tk()
root.title("Adding Calculator")


entry = Entry(root, width=50, fg='black', bg='white', borderwidth=5)
...
button_equal = Button(root, text="=", padx=96, pady=20, command=button_equal)
